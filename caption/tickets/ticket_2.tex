% Ticket #2 "Combining the caption and fltpage package when using twopage setting in book class"
% https://sourceforge.net/p/latex-caption/tickets/2/

\iffalse
From http://tex.stackexchange.com/questions/73456/
